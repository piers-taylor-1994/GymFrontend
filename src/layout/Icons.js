export const Settings = (props) => {
    return (
        <i className="icon" role="button" alt="settings button">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="-8 -6 130 130">
...
export const Leaderboard = (props) => {
    return (
        <i className="icon" role="button" alt="leaderboard button">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <g data-name="Layer 2">
...
export const AddSquare = (props) => {
    return (
        <i className="icon" role="button" alt="add square button">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <g data-name="Layer 2">
...
export const QrCode = (props) => {
    return (
        <i className="icon" role="button" alt="qr code button">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="1 1 21 21">
                <g data-name="Layer 2">
...
export const Edit = (props) => {
    return (
        <i className="icon" role="button" alt="edit button">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g data-name="Layer 2">
                <g data-name="edit">
                    <rect width="24" height="24" opacity="0" />
...
export const Rubbish = (props) => {
    return (
        <i className="icon" role="button" alt="rubbish button">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <g data-name="Layer 2">
                    <g data-name="trash">
                        <rect width="24" height="24" opacity="0" />
...
export const Draggable = (props) => {
    return (
        <i className="icon" role="button" alt="draggable2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <g data-name="Layer 2">
                    <g data-name="menu">
                        <rect x="3" y="11" width="18" height="2" rx=".95" ry=".95" />
                        <rect x="3" y="16" width="18" height="2" rx=".95" ry=".95" /><rect x="3" y="6" width="18" height="2" rx=".95" ry=".95" />
                    </g>
                </g>
            </svg>
        </i>
...
export const Book = (props) => {
    return (
        <i className="icon" role="button" alt="book button">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <g data-name="Layer 2">
