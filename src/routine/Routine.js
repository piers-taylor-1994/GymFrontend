...
function Routine() {
    ...
    function Sets(props) {
        ...
        const sets = routineList.length === 0 ? <p>A routine for today hasn't been added yet. <Link to={publicUrlAppender("/workouts")}>Please add one.</Link></p> : <DnD array={routineList} component={SetCard} update={() => console.log()}/>;
